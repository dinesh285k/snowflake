...
# load the file from the loacl folder 
```
...
# To see the table column use this command becasue parquet file cannt be readable
```
...
# Now have to crate the table using the column
```
...
# AFter creating the table copy the data from the file to table
```
